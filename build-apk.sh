...
ORIGINAL_EXPO_PUBLIC_ALLOW_CLEARTEXT="${EXPO_PUBLIC_ALLOW_CLEARTEXT-}"
...
if [[ ${EXPO_PUBLIC_ALLOW_CLEARTEXT+x} ]]; then
  CALLER_HAS_ALLOW_CLEARTEXT=1
fi
...
if [[ "$CALLER_HAS_ALLOW_CLEARTEXT" -eq 1 ]]; then
  export EXPO_PUBLIC_ALLOW_CLEARTEXT="$ORIGINAL_EXPO_PUBLIC_ALLOW_CLEARTEXT"
fi
