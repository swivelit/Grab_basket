...
<head>
    ...
    <title>Seller Login - GrabBaskets</title>
...
<body>
    <div class="login-container">
        <div class="login-header">
            <h1><i class="bi bi-shop"></i> Seller Portal</h1>
        ...
        <form action="{{ route('seller.login.submit') }}" method="POST">
            ...
            <button type="submit" class="btn btn-login">
                <i class="bi bi-box-arrow-in-right"></i> Login to Seller Portal
            </button>
        </form>
        ...
        <div class="footer-text">
            Not a seller yet? <a href="{{ route('home') }}">Go to home</a>
        </div>
    </div>
